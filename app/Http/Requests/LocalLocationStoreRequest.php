...
class LocalLocationStoreRequest extends BaseStoreRequest
{
    /**
    ...
    {
        return (bool) ($this->user()?->can('create', \App\Models\LocalLocation::class));
    }
    ...
    public function rules(): array
    {
        return [
            ...
            // 'code' => ['bail','required','string','max:50', Rule::unique('local_locations','code')->withoutTrashed()],
            // 'name' => ['bail','required','string','max:120'],
            // 'is_active' => ['nullable','boolean'],
            // 'sort_order' => ['nullable','integer'],
            'code' => ['bail', 'required', 'string', 'max:10', 'regex:/^[A-Z0-9]{1,4}$/', Rule::unique('local_locations', 'code')->withoutTrashed()],
