...
class ChargeStatusUpdateRequest extends BaseUpdateRequest
{
    /**
    ...
    {
        $current = $this->route('charge_status');
        ...
        return [
            ...
            // 'code' => ['bail','required','string','max:50', Rule::unique('charge_statuses','code')->ignore($currentId)->withoutTrashed()],
            // 'name' => ['bail','required','string','max:120'],
            // 'is_active' => ['nullable','boolean'],
            // 'sort_order' => ['nullable','integer'],
            '_version' => ['nullable', 'string'],
            'code' => ['bail', 'required', 'string', 'max:30', Rule::unique('charge_statuses', 'code')->ignore($currentId)->withoutTrashed()],
            'name' => ['bail', 'required', 'string', 'max:120'],
