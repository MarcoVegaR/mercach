...
class PaymentTypeUpdateRequest extends BaseUpdateRequest
{
    /**
    ...
    {
        $current = $this->route('payment_type');
        ...
        return [
            ...
            // 'code' => ['bail','required','string','max:50', Rule::unique('payment_types','code')->ignore($currentId)->withoutTrashed()],
