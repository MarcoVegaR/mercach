...
class MarketTariffIndexRequest extends BaseIndexRequest
{
    /**
    ...
    {
        return (bool) ($this->user()?->can('viewAny', \App\Models\MarketTariff::class));
    }
    ...
    {
        // Campos reales disponibles para ordenar en tarifas de mercado
        return ['id', 'market_id', 'valid_from', 'price_per_m2_eur_minor', 'is_active', 'created_at'];
    }
