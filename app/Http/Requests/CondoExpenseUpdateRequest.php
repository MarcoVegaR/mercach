...
class CondoExpenseUpdateRequest extends FormRequest
{
    ...
    public function after(): array
    {
        return [function (Validator $validator) {
            /** @var CondoExpense $expense */
            $expense = $this->route('condo_expense');
            ...
            $typeId = (int) $this->input('expense_type_id');
            if ($typeId > 0) {
                $exists = $period->expenses()
