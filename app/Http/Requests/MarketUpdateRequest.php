...
class MarketUpdateRequest extends BaseUpdateRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // 'code' => ['bail','required','string','max:50', Rule::unique('markets','code')->ignore($currentId)->withoutTrashed()],
