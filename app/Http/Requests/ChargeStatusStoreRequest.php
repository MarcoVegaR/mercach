...
class ChargeStatusStoreRequest extends BaseStoreRequest
{
    /**
    ...
    {
        return (bool) ($this->user()?->can('create', \App\Models\ChargeStatus::class));
    }
    ...
    public function rules(): array
    {
        return [
            ...
            // 'code' => ['bail','required','string','max:50', Rule::unique('charge_statuses','code')->withoutTrashed()],
            // 'name' => ['bail','required','string','max:120'],
            // 'is_active' => ['nullable','boolean'],
            // 'sort_order' => ['nullable','integer'],
            'code' => ['bail', 'required', 'string', 'max:30', Rule::unique('charge_statuses', 'code')->withoutTrashed()],
            'name' => ['bail', 'required', 'string', 'max:120'],
