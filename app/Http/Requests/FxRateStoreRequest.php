...
class FxRateStoreRequest extends BaseStoreRequest
{
    /**
    ...
    {
        return (bool) ($this->user()?->can('create', \App\Models\FxRate::class));
    }
    ...
    public function rules(): array
    {
        return [
            ...
            // 'code' => ['bail','required','string','max:50', Rule::unique('fx_rates','code')->withoutTrashed()],
            ...
            'operational_from' => [
                'bail', 'required', 'date',
                Rule::unique('fx_rates', 'operational_from')->where(function ($q) {
