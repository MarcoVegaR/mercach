...
class TradeCategoryUpdateRequest extends BaseUpdateRequest
{
    /**
    ...
    {
        $current = $this->route('trade_category');
        ...
        return [
            ...
            // 'code' => ['bail','required','string','max:50', Rule::unique('trade_categories','code')->ignore($currentId)->withoutTrashed()],
