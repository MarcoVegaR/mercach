...
class MarketStoreRequest extends BaseStoreRequest
{
    /**
    ...
    {
        return (bool) ($this->user()?->can('create', \App\Models\Market::class));
    }
    ...
    public function rules(): array
    {
        return [
            ...
            // 'code' => ['bail','required','string','max:50', Rule::unique('markets','code')->withoutTrashed()],
            ...
            'code' => [
                ...
                'max:20',
                'regex:/^[A-Z0-9_\-.]+$/',
                // Case-insensitive unique ignoring soft-deleted rows
