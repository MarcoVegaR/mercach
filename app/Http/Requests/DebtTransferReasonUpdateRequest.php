...
class DebtTransferReasonUpdateRequest extends BaseUpdateRequest
{
    /**
    ...
    {
        $current = $this->route('debt_transfer_reason');
        ...
        return [
            ...
            // 'code' => ['bail','required','string','max:50', Rule::unique('debt_transfer_reasons','code')->ignore($currentId)->withoutTrashed()],
            // 'name' => ['bail','required','string','max:120'],
            // 'is_active' => ['nullable','boolean'],
            // 'sort_order' => ['nullable','integer'],
            '_version' => ['nullable', 'string'],
            'code' => ['bail', 'required', 'string', 'max:30', Rule::unique('debt_transfer_reasons', 'code')->ignore($currentId)->withoutTrashed()],
