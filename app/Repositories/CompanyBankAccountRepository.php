...
use App\Contracts\Repositories\CompanyBankAccountRepositoryInterface;
use Illuminate\Database\Eloquent\Builder;

class CompanyBankAccountRepository extends BaseRepository implements CompanyBankAccountRepositoryInterface
{
    protected string $modelClass = \App\Models\CompanyBankAccount::class;
     ...
     *
     * @return array<string, callable(Builder<\App\Models\CompanyBankAccount>, mixed): void>
     */
