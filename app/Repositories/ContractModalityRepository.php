...
use App\Contracts\Repositories\ContractModalityRepositoryInterface;
use Illuminate\Database\Eloquent\Builder;

class ContractModalityRepository extends BaseRepository implements ContractModalityRepositoryInterface
{
    protected string $modelClass = \App\Models\ContractModality::class;
