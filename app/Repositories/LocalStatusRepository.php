...
use App\Contracts\Repositories\LocalStatusRepositoryInterface;
use Illuminate\Database\Eloquent\Builder;

class LocalStatusRepository extends BaseRepository implements LocalStatusRepositoryInterface
{
    protected string $modelClass = \App\Models\LocalStatus::class;
