...
use App\Contracts\Repositories\DebtTransferReasonRepositoryInterface;
use Illuminate\Database\Eloquent\Builder;

class DebtTransferReasonRepository extends BaseRepository implements DebtTransferReasonRepositoryInterface
{
    protected string $modelClass = \App\Models\DebtTransferReason::class;
     ...
     *
     * @return array<string, callable(Builder<\App\Models\DebtTransferReason>, mixed): void>
     */
