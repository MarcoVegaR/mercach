...
use App\Contracts\Repositories\LocalTypeRepositoryInterface;
use Illuminate\Database\Eloquent\Builder;

class LocalTypeRepository extends BaseRepository implements LocalTypeRepositoryInterface
{
    protected string $modelClass = \App\Models\LocalType::class;
