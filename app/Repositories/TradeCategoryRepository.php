...
use App\Contracts\Repositories\TradeCategoryRepositoryInterface;
use Illuminate\Database\Eloquent\Builder;

class TradeCategoryRepository extends BaseRepository implements TradeCategoryRepositoryInterface
{
    protected string $modelClass = \App\Models\TradeCategory::class;
