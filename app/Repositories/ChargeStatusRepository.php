...
use App\Contracts\Repositories\ChargeStatusRepositoryInterface;
use Illuminate\Database\Eloquent\Builder;

class ChargeStatusRepository extends BaseRepository implements ChargeStatusRepositoryInterface
{
    protected string $modelClass = \App\Models\ChargeStatus::class;
     ...
     *
     * @return array<string, callable(Builder<\App\Models\ChargeStatus>, mixed): void>
     */
