...
use App\Contracts\Repositories\LocalLocationRepositoryInterface;
use Illuminate\Database\Eloquent\Builder;

class LocalLocationRepository extends BaseRepository implements LocalLocationRepositoryInterface
{
    protected string $modelClass = \App\Models\LocalLocation::class;
