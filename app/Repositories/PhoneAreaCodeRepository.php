...
use App\Contracts\Repositories\PhoneAreaCodeRepositoryInterface;
use Illuminate\Database\Eloquent\Builder;

class PhoneAreaCodeRepository extends BaseRepository implements PhoneAreaCodeRepositoryInterface
{
    protected string $modelClass = \App\Models\PhoneAreaCode::class;
