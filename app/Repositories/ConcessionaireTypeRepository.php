...
use App\Contracts\Repositories\ConcessionaireTypeRepositoryInterface;
use Illuminate\Database\Eloquent\Builder;

class ConcessionaireTypeRepository extends BaseRepository implements ConcessionaireTypeRepositoryInterface
{
    protected string $modelClass = \App\Models\ConcessionaireType::class;
