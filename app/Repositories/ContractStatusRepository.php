...
use App\Contracts\Repositories\ContractStatusRepositoryInterface;
use Illuminate\Database\Eloquent\Builder;

class ContractStatusRepository extends BaseRepository implements ContractStatusRepositoryInterface
{
    protected string $modelClass = \App\Models\ContractStatus::class;
