...
class PaymentFinancialSummaryPdfGenerator
{
    /**
    ...
    public function render(array $data): array
    {
        ...
        $from = (string) ($filters['paid_from'] ?? date('Y-m-d'));
        $to = (string) ($filters['paid_to'] ?? date('Y-m-d'));
        $filenamePrefix = $reportType === 'exonerations' ? 'reporte_exoneraciones' : 'reporte_ingresos';
        $filename = $filenamePrefix.'_'.$from.'_'.$to.'_'.date('His').'.pdf';
