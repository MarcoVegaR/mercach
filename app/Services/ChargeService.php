...
class ChargeService extends BaseService implements ChargeServiceInterface
{
    ...
    protected function toRow(Model $model): array
    {
        ...
        return [
            ...
            'amount_bs_minor_issued' => $model->getAttribute('amount_bs_minor_issued'),
            'allocated_bs_minor' => (int) ($model->getAttribute('allocated_bs_minor') ?? 0),
            'fx_rate_issued_id' => $model->getAttribute('fx_rate_issued_id'),
