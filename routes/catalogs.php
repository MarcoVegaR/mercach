...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/catalogs/local-type/{local_type}/data', [\App\Http\Controllers\LocalTypeController::class, 'showData'])->middleware('permission:catalogs.local-type.view')->name('catalogs.local-type.showData');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/catalogs/local-status/{local_status}/data', [\App\Http\Controllers\LocalStatusController::class, 'showData'])->middleware('permission:catalogs.local-status.view')->name('catalogs.local-status.showData');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/catalogs/market/{market}/data', [\App\Http\Controllers\MarketController::class, 'showData'])->middleware('permission:catalogs.market.view')->name('catalogs.market.showData');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/catalogs/local-location/{local_location}/data', [\App\Http\Controllers\LocalLocationController::class, 'showData'])->middleware('permission:catalogs.local-location.view')->name('catalogs.local-location.showData');
