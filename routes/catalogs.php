...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/catalogs/concessionaire/life-proof-forms', [\App\Http\Controllers\ConcessionaireController::class, 'printLifeProofForms'])->middleware('permission:catalogs.concessionaire.view')->name('catalogs.concessionaire.life-proof-forms.get');
    Route::post('/catalogs/concessionaire/life-proof-forms', [\App\Http\Controllers\ConcessionaireController::class, 'printLifeProofForms'])->middleware('permission:catalogs.concessionaire.view')->name('catalogs.concessionaire.life-proof-forms');
    ...
    Route::get('/catalogs/concessionaire/{concessionaire}/profile-pdf', [\App\Http\Controllers\ConcessionaireController::class, 'profilePdf'])->middleware('permission:catalogs.concessionaire.view')->name('catalogs.concessionaire.profile-pdf');
    ...
    Route::post('/catalogs/concessionaire/{concessionaire}/life-proof', [\App\Http\Controllers\ConcessionaireController::class, 'recordLifeProof'])->middleware('permission:catalogs.concessionaire.update')->name('catalogs.concessionaire.life-proof');
