    ...
    <div class="row">
        ...
        <div class="col">
            <div class="box">
                ...
                <div class="small">Fecha de pago: {{ $payment->paid_on ? \Illuminate\Support\Carbon::parse((string) $payment->paid_on)->format('d/m/Y') : '—' }}</div>
                <div class="small">Fecha de emisión: {{ optional($receipt->issued_at)->format('d/m/Y H:i') ?: '—' }}</div>
