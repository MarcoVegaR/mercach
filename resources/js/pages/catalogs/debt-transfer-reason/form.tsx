...
export default function FormPage(props: PageProps) {
    ...
    function handleCancel() {
        router.visit('/catalogs/debt-transfer-reason', { preserveScroll: true });
    }
    ...
    function handleSubmit(e: React.FormEvent) {
        ...
        if (mode === 'create') {
            form.post(route('catalogs.debt-transfer-reason.store'));
        } else {
            const id = initial.id;
            ...
            form.put(route('catalogs.debt-transfer-reason.update', id));
        }
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={mode === 'edit' ? 'Editar Motivo de traspaso de deuda' : 'Crear Motivo de traspaso de deuda'} />
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
                <div className="py-8">
                    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                        <h1 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
                            {mode === 'edit' ? 'Editar' : 'Crear'} Motivo de traspaso de deuda
                        </h1>
