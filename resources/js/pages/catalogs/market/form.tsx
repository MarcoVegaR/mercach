...
export default function FormPage(props: PageProps) {
    ...
    function handleCancel() {
        router.visit('/catalogs/market', { preserveScroll: true });
    }
    ...
    function handleSubmit(e: React.FormEvent) {
        ...
        if (mode === 'create') {
            clearUnsavedChanges();
            form.post(route('catalogs.market.store'));
        } else {
            const id = initial.id;
            ...
            clearUnsavedChanges();
            form.put(route('catalogs.market.update', id));
        }
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={mode === 'edit' ? 'Editar Mercado' : 'Crear Mercado'} />
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
                <div className="py-8">
                    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                        <h1 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">{mode === 'edit' ? 'Editar' : 'Crear'} Mercado</h1>
                        ...
                        <TooltipProvider delayDuration={300}>
                            <form onSubmit={handleSubmit} className="bg-card space-y-6 rounded-2xl border p-6 shadow-sm lg:p-7">
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    <Field id="address" label="Dirección" error={form.errors.address} tooltip="Dirección completa del mercado">
                                        <Input
                                            name="address"
