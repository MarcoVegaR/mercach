...
import { Database, Landmark, Plus } from 'lucide-react';
...
export default function IndexPage() {
    ...
    const [density, setDensity] = React.useState<'comfortable' | 'compact'>(() => {
        ...
        const saved = window.localStorage.getItem('company-bank-account_table_density');
        return saved === 'compact' ? 'compact' : 'comfortable';
    });

    const permissions = {
        canCreate: auth?.can?.['catalogs.company-bank-account.create'] || false,
        canEdit: auth?.can?.['catalogs.company-bank-account.update'] || false,
        canDelete: auth?.can?.['catalogs.company-bank-account.delete'] || false,
        canExport: auth?.can?.['catalogs.company-bank-account.export'] || false,
        canBulkDelete: auth?.can?.['catalogs.company-bank-account.delete'] || false,
        canSetActive: auth?.can?.['catalogs.company-bank-account.setActive'] || false,
        canBulkSetActive: auth?.can?.['catalogs.company-bank-account.setActive'] || false,
    };
    ...
    const reloadData = React.useCallback(() => {
        ...
        router.get('/catalogs/company-bank-account', params, {
            only: ['rows', 'meta'],
            preserveState: true,
            preserveScroll: true,
        });
    ...
    const handleExport = React.useCallback(
        (format: string = 'csv') => {
            ...
            window.location.href = `/catalogs/company-bank-account/export?${usp.toString()}`;
        },
        [pageIndex, pageSize, globalFilter, sorting],
    );
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mb-8 flex items-center justify-between">
                            ...
                            {permissions.canCreate && (
                                <Link href="/catalogs/company-bank-account/create">
                            ...
                            <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Cuentas receptoras</p>
                                ...
                                <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Cuentas receptoras activas</p>
                        ...
                        <div className="overflow-hidden rounded-xl bg-white shadow-lg ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
                            <div className="p-6">
                                <DataTable
                                    ...
                                    searchPlaceholder="Buscar banco, número, titular..."
                                    ...
                                    onDensityChange={(d) => {
                                        setDensity(d);
                                        if (typeof window !== 'undefined') window.localStorage.setItem('company-bank-account_table_density', d);
                                    }}
                                    stickyLeftColumnId="bank_name"
                        ...
                        <ConfirmAlert
                            ...
                            onConfirm={async () => {
                                ...
                                await new Promise<void>((resolve, reject) => {
                                    router.post(
                                        '/catalogs/company-bank-account/bulk',
                                        { action: 'delete', ids },
                                        {
                                            preserveState: false,
                                            preserveScroll: true,
