...
export default function ShowPage() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Ubicación de local: ${String((item as any).name ?? (item as any).code ?? (item as any).id)}`} />
                        ...
                        <CardContent className="pt-6">
                            <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div>
                                    ...
                                    <dd className="mt-1 text-sm">{formatDate(((item as any).created_at as string | null | undefined) ?? null)}</dd>
                                </div>
                                <div>
                                    <dt className="text-muted-foreground text-sm font-medium">
                                        <Calendar className="mr-1 inline h-4 w-4 text-green-500" />
                                    ...
                                    <dd className="mt-1 text-sm">{formatDate(((item as any).updated_at as string | null | undefined) ?? null)}</dd>
                                </div>
                            </dl>
                        </CardContent>
                    </Card>
