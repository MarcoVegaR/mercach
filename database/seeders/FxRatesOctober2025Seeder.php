...
class FxRatesOctober2025Seeder extends Seeder
{
    public function run(): void
    {
        $rows = [
            ...
            '2026-01-22' => ['USD' => 349.92, 'EUR' => 409.64],
            '2026-01-23' => ['USD' => 352.70, 'EUR' => 413.38],
            '2026-01-26' => ['USD' => 355.55, 'EUR' => 417.58],
            '2026-01-27' => ['USD' => 358.92, 'EUR' => 426.18],
            '2026-01-28' => ['USD' => 361.49, 'EUR' => 432.71],
            '2026-01-29' => ['USD' => 363.66, 'EUR' => 434.42],
            '2026-01-30' => ['USD' => 367.30, 'EUR' => 439.46],

            '2026-02-02' => ['USD' => 370.25, 'EUR' => 440.47],
        ];
